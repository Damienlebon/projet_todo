 ...
 */
final class Version20231026043556 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache ADD CONSTRAINT FK_93872075C485B416 FOREIGN KEY (name_liste_id) REFERENCES liste (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
